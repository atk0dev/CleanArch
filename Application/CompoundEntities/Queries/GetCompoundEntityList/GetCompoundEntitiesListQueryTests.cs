...
{
    [TestFixture]
    public class GetCompoundEntitiesListQueryTests
    {
        private GetCompoundEntitiesListQuery _query;
        ...
        public void SetUp()
        {
            ...
            _query = _mocker.Create<GetCompoundEntitiesListQuery>();
        }

        [Test]
        public void TestExecuteShouldReturnListOfCompoundEntities()
        {
            ...
            Assert.That(result.AnotherEntityName, 
